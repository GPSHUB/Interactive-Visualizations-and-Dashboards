...
// class act 14 / day 2 / activity 7 line 15 // append("p") appends new paragraph
// Appending looped metadata object entries to the demo info panel in the index.html
    ...
    // Isolating objects for bar chart
    function barChart () {
        let dropInput = d3.select("#selDataset");

        let dropValue = dropInput.property("value");
